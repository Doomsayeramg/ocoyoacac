...
import com.blogspot.ofarukkurt.primeadminbsb.services.PagoFacade;
...
@FacesConverter(value = "pagoConverter")
public class PagoConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Pago) {
            Pago o = (Pago) object;
            return getStringKey(Integer.parseInt(o.getIdPago().toString()));
        } else {
